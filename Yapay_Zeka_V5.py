...
if __name__ == "__main__":
    ...
    katalog_metni = read_bursa_pdf()
    if katalog_metni:
        system_prompt += f"\n\nDİKKAT! Aşağıda sana sağlanan 'Bursa Kataloğu' bilgilerini kesinlikle kullan. Kullanıcı sana bir şey sorduğunda, eğer cevabı bu katalogda varsa sadece buradan cevap ver:\n\n--- BURSA KATALOĞU İÇERİĞİ ---\n{katalog_metni[:15000]}\n----------------------"
